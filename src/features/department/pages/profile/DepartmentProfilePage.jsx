...
import DepartmentProfileLoader from "../../components/profile/DepartmentProfileLoader";
...
function DepartmentProfilePage() {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Thông tin Nhân viên Phòng Ban</h1>
      <DepartmentProfileLoader reload={reloadProfile}>
        {({ profile }) =>
          profile ? (
                ...
                <div className="p-6 bg-white rounded-xl">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-2">
                      ...
                      {[
                        ["Phòng ban", profile.employee_department?.name],
