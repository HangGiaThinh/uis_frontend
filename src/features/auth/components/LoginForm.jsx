...
// Component form đăng nhập, hỗ trợ validation và hiển thị lỗi
        ...
        <div className="w-full max-w-xs mx-auto rounded-md shadow-lg mb-5">
            <div className="bg-white p-4 rounded-md">
                ...
                <button
                    ...
                    disabled={loading}
                    className={`w-full bg-[#00AEEF] text-white p-2 rounded-md text-sm hover:bg-blue-600 flex items-center justify-center ${loading ? "opacity-70 cursor-not-allowed" : ""}`}
                >
